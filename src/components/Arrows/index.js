...
export const ArrowLeft = ({onClick, disabled}) => {
    return (
        <Left disabled={disabled} onClick={disabled ? undefined : onClick} >
...
export const ArrowRight = ({onClick, disabled}) => {
    return (
        <Right disabled={disabled} onClick={disabled ? undefined : onClick} >
            <svg xmlns="http://www.w3.org/2000/svg" width="15" viewBox="0 0 8 16">
